...
const IGNORE_ATTRIBUTE = 'data-html2pptx-ignore';
...
export class DocumentCloner {
    ...
    toIFrame(ownerDocument: Document, windowSize: Bounds): Promise<HTMLIFrameElement> {
        ...
        try {
            ...
            // Reuse existing policy when present (e.g. second html2pptx call) to avoid createPolicy duplicate-name throw.
            ...
            let policy = trustedTypesFactory?.getPolicy?.('html2pptx-pro');
            if (!policy && trustedTypesFactory) {
                policy = trustedTypesFactory.createPolicy('html2pptx-pro', {
    ...
    resolvePseudoContent(
        ...
        const anonymousReplacedElement = document.createElement('html2pptxpseudoelement');
...
const createIFrameContainer = (
    ...
    cloneIframeContainer.className = 'html2pptx-container';
    cloneIframeContainer.style.visibility = 'hidden';
    cloneIframeContainer.style.position = 'fixed';
    cloneIframeContainer.style.left = '-10000px';
    cloneIframeContainer.style.top = '0px';
    cloneIframeContainer.style.border = '0';
    cloneIframeContainer.style.opacity = '0';
    cloneIframeContainer.style.pointerEvents = 'none';
...
const PSEUDO_HIDE_ELEMENT_CLASS_BEFORE = '___html2pptx___pseudoelement_before';
const PSEUDO_HIDE_ELEMENT_CLASS_AFTER = '___html2pptx___pseudoelement_after';
